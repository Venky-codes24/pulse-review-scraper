...
- Metadata such as company name, date range, source, and execution time
- Review details including title, review text, date, rating, and source

---

## Error Handling
- Network and request failures are safely handled
- Blocked requests (403 Forbidden) are logged as warnings
- Missing or malformed data is skipped gracefully
- Empty results still generate a valid JSON output

---

## Conclusion
This project provides a clean, extensible, and assignment-ready solution that meets all the requirements of the Pulse Coding Assignment while demonstrating good software engineering practices.
